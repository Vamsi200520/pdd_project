...
class Symptom(Base):
    ...
    chest_tightness_rating = Column(Integer, nullable=True)
    activity_limitation_rating = Column(Integer, nullable=True)
    rescue_inhaler_puffs = Column(Integer, nullable=True)
